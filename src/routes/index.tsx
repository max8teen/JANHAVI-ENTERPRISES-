  ...
  return (
    <section className="relative w-full overflow-hidden" style={{ minHeight: "min(95vh, 760px)" }}>
      ...
      {/* Background image
          ...
          Mobile:  object-[75%_top] — shows man on right side, filter visible, anchored to top */}
      <img
        src={heroDesktop}
        alt=""
        aria-hidden="true"
      ...
      />
      {/* Mobile gradient: top clear → white from 52% so text is readable but man stays visible */}
      <div
        className="absolute inset-0 lg:hidden"
        style={{
          background:
            "linear-gradient(to bottom, rgba(255,255,255,0) 0%, rgba(255,255,255,0) 42%, rgba(255,255,255,0.93) 56%, rgba(255,255,255,1) 65%)",
        }}
      />
      ...
      <div className="relative z-10 flex h-full flex-col lg:hidden" style={{ minHeight: "inherit" }}>
        ...
        {/* Spacer — 42% so man face+chest+filter all visible above content */}
